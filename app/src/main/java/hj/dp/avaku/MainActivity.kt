...
private const val BASE_FACE_WIDTH = 911f
private const val BASE_FACE_HEIGHT = 1293f
private const val BASE_FACE_ASPECT_RATIO = BASE_FACE_HEIGHT / BASE_FACE_WIDTH
private const val EYEBROWS_WIDTH_RATIO = 237f / BASE_FACE_WIDTH
private const val EYEBROWS_HEIGHT_RATIO = 131f / BASE_FACE_HEIGHT
private const val EYEBROWS_TOP_OFFSET_RATIO = 340f / BASE_FACE_HEIGHT
private const val EYES_WIDTH_RATIO = 181f / BASE_FACE_WIDTH
private const val EYES_HEIGHT_RATIO = 126f / BASE_FACE_HEIGHT
private const val EYES_TOP_OFFSET_RATIO = 410f / BASE_FACE_HEIGHT
private const val MOUTH_WIDTH_RATIO = 601f / BASE_FACE_WIDTH
private const val MOUTH_HEIGHT_RATIO = 174f / BASE_FACE_HEIGHT
private const val MOUTH_TOP_OFFSET_RATIO = 880f / BASE_FACE_HEIGHT
private const val SMILE_WIDTH_RATIO = 597f / BASE_FACE_WIDTH
private const val SMILE_HEIGHT_RATIO = 59f / BASE_FACE_HEIGHT
private const val SMILE_TOP_OFFSET_RATIO = 940f / BASE_FACE_HEIGHT
        ...
        Column(
            ...
            Column(
                ...
                BoxWithConstraints(modifier = Modifier.fillMaxWidth()) {
                    val avatarWidth = if (maxWidth < 260.dp) maxWidth else 260.dp
                    val avatarHeight = avatarWidth * BASE_FACE_ASPECT_RATIO
                    ...
                    Box(
                        ...
                        Box(modifier = Modifier.size(avatarWidth, avatarHeight)) {
                            Image(
                            ...
                            if (showEyes) {
                                AvatarFeatureLayer(
                                    ...
                                    baseWidth = avatarWidth,
                                    baseHeight = avatarHeight,
                                    widthRatio = EYES_WIDTH_RATIO,
                                    heightRatio = EYES_HEIGHT_RATIO,
                                    topOffsetRatio = EYES_TOP_OFFSET_RATIO
                                )
                            }
                            if (showEyebrows) {
                                AvatarFeatureLayer(
                                    ...
                                    baseWidth = avatarWidth,
                                    baseHeight = avatarHeight,
                                    widthRatio = EYEBROWS_WIDTH_RATIO,
                                    heightRatio = EYEBROWS_HEIGHT_RATIO,
                                    topOffsetRatio = EYEBROWS_TOP_OFFSET_RATIO
                                )
                            }
                            if (showMouth) {
                                AvatarFeatureLayer(
                                    ...
                                    baseWidth = avatarWidth,
                                    baseHeight = avatarHeight,
                                    widthRatio = MOUTH_WIDTH_RATIO,
                                    heightRatio = MOUTH_HEIGHT_RATIO,
                                    topOffsetRatio = MOUTH_TOP_OFFSET_RATIO
                                )
                            }
                            if (showSmile) {
                                AvatarFeatureLayer(
                                    ...
                                    baseWidth = avatarWidth,
                                    baseHeight = avatarHeight,
                                    widthRatio = SMILE_WIDTH_RATIO,
                                    heightRatio = SMILE_HEIGHT_RATIO,
                                    topOffsetRatio = SMILE_TOP_OFFSET_RATIO
                                )
                            }
                        }
                    }
...
@Composable
private fun BoxScope.AvatarFeatureLayer(
    painter: Painter,
    ...
    Image(
        ...
        modifier = Modifier
            ...
            .offset(y = baseHeight * topOffsetRatio)
            .size(
